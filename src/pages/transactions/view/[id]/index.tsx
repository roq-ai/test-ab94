              ...
              >
                ...
                <FormListItem
                  ...
                  text={
                    data?.transaction_date
                      ? format(parseISO(data?.transaction_date as unknown as string), 'dd-MM-yyyy')
                      : ''
                  }
                />

                <FormListItem label="Transaction Price" text={data?.transaction_price} />
                ...
                {hasAccess('holding', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Holding"
                    text={
                      <Link as={NextLink} href={`/holdings/view/${data?.holding?.id}`}>
                        {data?.holding?.purchase_price}
                      </Link>
                    }
                  />
                )}
