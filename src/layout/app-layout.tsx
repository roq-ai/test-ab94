...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Holdings', path: '/holdings', entity: 'holding', service: AccessServiceEnum.PROJECT, icon: FiShoppingBag },
    { name: 'Stocks', path: '/stocks', entity: 'stock', service: AccessServiceEnum.PROJECT, icon: FiTrendingUp },
    {
      name: 'Transactions',
      path: '/transactions',
      entity: 'transaction',
